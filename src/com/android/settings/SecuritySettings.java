...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        //allows for calling the settings screen with stock or cm view
        ...
        if (mLockAfter != null) {
            ...
            addPreferencesFromResource(R.xml.security_settings_slide_delay_sourcery);
        ...
        if (isCmSecurity) {
            ...
            addPreferencesFromResource(R.xml.security_settings_sourcery);
